...
public class VistaModificarEmpresa extends JFrame {
	...
	public VistaModificarEmpresa() {
		...
		JLabel lblModificarEmpresa = new JLabel("MODIFICAR EMPRESA");
		lblModificarEmpresa.setFont(new Font("Tahoma", Font.BOLD, 16));
		panel_1.add(lblModificarEmpresa);
	}
