...
public class VistaModificarCentro extends JFrame {
	...
	private JTextField txtNIFDirector;
	...
	public VistaModificarCentro() {
		...
		lblCentro.setBounds(12, 11, 46, 14);
		panel.add(lblCentro);
		
		JLabel lblDir = new JLabel("Director");
		lblDir.setBounds(12, 38, 46, 14);
		panel.add(lblDir);
		
		JLabel lblRepresentante = new JLabel("Representante");
		lblRepresentante.setBounds(12, 63, 86, 14);
		panel.add(lblRepresentante);
		
		JLabel lblDireccion = new JLabel("Direccion");
		lblDireccion.setBounds(217, 11, 65, 14);
		panel.add(lblDireccion);
		
		JLabel lblMunicipio = new JLabel("Municipio");
		lblMunicipio.setBounds(217, 113, 65, 14);
		...
		lblCodCentro.setBounds(12, 88, 65, 14);
		panel.add(lblCodCentro);
		
		JLabel lblNifDirector = new JLabel("NIF Director");
		lblNifDirector.setBounds(12, 113, 86, 14);
		...
		lblLocalidad.setBounds(217, 88, 65, 14);
		panel.add(lblLocalidad);
		
		JLabel lblProvincia = new JLabel("Provincia");
		lblProvincia.setBounds(217, 138, 65, 14);
		...
		txtNIFDirector = new JTextField();
		txtNIFDirector.setColumns(10);
		txtNIFDirector.setBounds(121, 110, 86, 20);
		panel.add(txtNIFDirector);
		...
		txtProv.setBounds(279, 135, 86, 20);
		panel.add(txtProv);
		...
		JLabel lblModificarCentro = new JLabel("MODIFICAR CENTRO");
		lblModificarCentro.setFont(new Font("Tahoma", Font.BOLD, 16));
		panel_1.add(lblModificarCentro);
	}
